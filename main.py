...
#function to check if products in buy are expired
def is_expired():
    date = get_date()
...
def sell():
    ...
    sell_id = get_id()
    bought_id = find_info('bought.csv', product_name, 'bought_id')
    buy_date = find_info('bought.csv', product_name, 'buy_date')
